            ...
            <div class="content-block">
                ...
                foreach ($images as $image) {
                   ...
                   $full = wp_get_attachment_image_src( $image, 'full' );
                    ...
                    echo '<a class="image-link" href="'. $full[0] .'"><img class="image_' . ++$i;
                    if ( $i === 1 )
                        echo ' no_lazy';
                    echo '" src="' . $src[0] . '" /></a>';
                ...
                if (has_post_format( 'video' )): ?>
                    <iframe class="video2" width="560" height="315" src="https://www.youtube.com/embed/<?php echo youtube_code($meta['video_code_2'][0]) ?>" frameborder="0" allowfullscreen></iframe>
                <?php endif ?>
                <?php the_content(); ?>
