...
add_action('admin_menu','App\remove_default_post_type');
...
add_action( 'admin_menu', 'App\remove_redux_menu',12 );
...
//add_action(  'wp_enqueue_scripts' ,'App\\bssgroup_theme_enqueue_styles' );
...
*
***************************************************************************/
add_action(  'wp_head' ,'App\\bssgroup_seo_meta' );
...
add_action(  'init' ,'App\\bssGroup_Staff_Mebmbers' );
...
function member_add_meta_box() {
	...
	foreach ( $screens as $screen ) {
	    ...
	    add_meta_box(
	        ...
	        'App\\member_meta_box_callback',
	        $screen
	    );
 	}
}
add_action(  'add_meta_boxes' ,'App\\member_add_meta_box' );
...
add_action(  'save_post' ,'App\\member_save_meta_box_data' );
...
add_action(  'init' ,'App\\bssGroup_Media' );
...
if ( 'post.php' == $hook || 'post-new.php' == $hook ) {
  ...
  add_action( 'admin_enqueue_scripts' ,'App\\gallery_metabox_enqueue' );
...
add_action(  'admin_init' ,'App\\add_post_format_metabox' );
...
add_action(  'save_post' ,'App\\save_metaboxes' );
 
function save_metaboxes( $post_id ) {
    global $metaboxes;
 
    // verify nonce
    if ( ! wp_verify_nonce( isset($_POST['post_format_meta_box_nonce']) ? $_POST['post_format_meta_box_nonce'] : '', basename( __FILE__ ) ) )
        return $post_id;
...
add_action(  'admin_head' ,'App\\admin_inline_js' );
/***************************************************************************
*
*							News Post Types
*
...
add_action(  'init' ,'App\\bssGroup_News' );
/***************************************************************************
*
*							Services Post Types
*
...
add_action(  'init' ,'App\\bssGroup_services' );
/***************************************************************************
*
*							Events Post Types
*
...
add_action(  'init' ,'App\\bssGroup_events' );
/***************************************************************************
*
*								Projects
*
...
add_action(  'init' ,'App\\bssGroup_projects' );
...
add_action(  'add_meta_boxes' ,'App\\wpshed_add_custom_meta_box' );
...
add_action(  'save_post' ,'App\\wpshed_meta_box_save' );

add_action( 'admin_init' ,'App\\hhs_add_meta_boxes' );
...
add_action( 'save_post' ,'App\\hhs_repeatable_meta_box_save' );
...
add_action( 'admin_init' ,'App\\hhs_add_meta_boxes2' );
...
add_action( 'save_post' ,'App\\hhs_repeatable_meta_box_save2' );
...
class Meta_Box_Media_Upload {
	function __construct() {
        //add_action(  'add_meta_boxes' ,'App\\$this\\setup_box' );
...
add_action(  'init' ,'App\\bssGroup_jobs' );
add_action( 'admin_init' ,'App\\hhs_add_meta_boxes3' );
...
add_action( 'save_post' ,'App\\hhs_repeatable_meta_box_save3' );
...
add_action(  'add_meta_boxes' ,'App\\wpshed_add_custom_meta_box2' );
...
add_action(  'save_post' ,'App\\wpshed_meta_box_save2' );
/***************************************************************************
*
*								 Comments
*
...
*
***************************************************************************/
add_action( 'wp_head' ,'App\\pluginname_ajaxurl' );
...
add_action( 'wp_ajax_my_special_ajax_call' ,'App\\formHomeSubmision' );
add_action( 'wp_ajax_nopriv_my_special_ajax_call' ,'App\\formHomeSubmision' );
/***************************************************************************
*
*								Menus
*
...
//add_action( 'wp_footer' ,'App\\add_script_footer' );